...
public class PanelSaisie extends JPanel {
	...
	public PanelSaisie() {
		...
		// Bouton pour importer des pièces jointes
		...
		// Panneau pour afficher les pièces jointes (masqué par défaut)
		...
		scrollPanePiecesJointes.setPreferredSize(new Dimension(0, 65)); // Hauteur initiale
	...
	private void addAttachment() {
		...
		if (returnValue == JFileChooser.APPROVE_OPTION) {
			...
			// Ajouter une représentation visuelle de la pièce jointe
			...
			panelPiecesJointes.revalidate();
			panelPiecesJointes.repaint();
			scrollPanePiecesJointes.revalidate();
			scrollPanePiecesJointes.repaint();
